...
\def\figure{\includegraphics{Fig4.eps}}
...
\begin{document}
        ...
        \psfrag{nL}[B][B]{$\bar{n}_L/n^{\mathrm{th}}_L$}
        \psfrag{nR}[B][B]{$\bar{n}_R/n^{\mathrm{th}}_R$}
        \psfrag{eps}[B][B]{$\epsilon\ [\Gamma_S]$}
        \psfrag{IL}[B][B]{$I_\alpha\ [e\Gamma]$}
