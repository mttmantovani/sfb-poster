...
%==================================================
% General settings and additional color definitions
%==================================================
\format{a0}
...
\newenvironment{rframe}[1][1]{
	\begin{tikzpicture}[remember picture]
	\refstepcounter{frameidcounter} 
 	\node[draw=red,rounded corners=0em, line width=2pt,fill=white, inner xsep=1em,fill opacity=0.9](frameid \arabic{frameidcounter})\bgroup%
...
\newenvironment{pframe}[1][\textwidth]{
	\begin{tikzpicture}[remember picture]
	\refstepcounter{frameidcounter} 
 	\node[draw=seeblau100,rounded corners=0em,line width=2pt,fill=white, inner sep=1ex,text width=\textwidth,fill opacity=0.9](frameid \arabic{frameidcounter})\bgroup%
	\begin{minipage}[t]{#1}
}{
	\end{minipage}\egroup;
	\end{tikzpicture}
...
\newenvironment{pframe2}[1][\textwidth]{
	\begin{tikzpicture}[remember picture]
 	\node[draw=seeblau100,rounded corners=0em,line width=2pt,fill=white, inner sep=1ex,text width=\textwidth,fill opacity=0.9](frameid \arabic{frameidcounter})\bgroup%
	\begin{minipage}[t]{#1}
}{
...
% Define Logos
%====================================
\newcommand{\sfblogo}[1][sfb767_Logo.png]{
	\begin{textfeld}{0cm}{12.9cm}%
		\rightskip \margin
		\hfill\includegraphics[scale=0.8]{#1}
	\end{textfeld}%
}

%\newcommand{\zukologo}[1][Zukunftskolleg_Logo.png]{
%	\begin{textfeld}{0cm}{\margin}%
%		\rightskip 25cm
%		\hfill\includegraphics[scale=1.5]{graphics/Zukunftskolleg_Logo.png}
%	\end{textfeld}%
%}
%====================================
...
\newcommand{\header}{
	\selectfontsize{82pt}
	\markieren{\textbf{Single-atom laser and single-photon pump}}{\textbf{in quantum-dot-based hybrid nanodevices}}{}{}\\[2cm]
	\selectfontsize{50pt}
	\underline{\textbf{M. Mantovani}}\rlap{,}\textsuperscript{1} 
	A. D. Armour\rlap{,}\textsuperscript{2}
...
\newcommand{\intro}{
	\begin{pframe}
			\selectfontsize{30pt}\underline{\textbf{Introduction and motivation}}
	\end{pframe}
}

\newcommand{\introduction}{ %
	\cdblock[width=\textwidth, columnnum=2, columnspace=0pt, inner=long, 
	block=true]{\selectfontsize{30pt}\underline{\textbf{Introduction and motivation}}}{
	\raggedright
	\selectfontsize{24pt}
	...
	exchange} in 
	nanodevices~\cite{Hussein2019}\\[1ex]
	\end{itemize}
	%
	\begin{center}
		\begin{multicols}{2}
	...
	resonators)~\cite{Mantovani2019,Rozhkov2000,Hussein2016}\\[2.8ex]
...
\newcommand{\laser}{
	...
	\markieren{\textbf{Dynamical multistability in a quantum-dot laser}}{}{}{}
	}{
	\vspace{0.5cm}
	
	\markieren{\textbf{Single-photon pump by Cooper-pair splitting }}{}{}{}
	}{}{}{}{}{}{}
}
...
%	\begin{tikzpicture}[remember picture, overlay]
%		\node[anchor=east] at (0,0) (head) {};
%		\node[anchor=west] at (\textwidth, 0) (tail) {};
%		\draw[line width=12 pt] (head) -- (tail);
%	\end{tikzpicture}
